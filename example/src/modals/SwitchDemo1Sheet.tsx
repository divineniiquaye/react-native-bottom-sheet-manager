...
export default function SwitchDemo1Sheet({ id }: SheetProps<"switch-demo-1">) {
  const openNext = async () => {
    await SheetManager.show("switch-demo-2", {
  ...
  const openWithBehavior = async (behavior: "replace" | "push") => {
    if (behavior === "replace") {
      await SheetManager.show("replace-demo-1", {
        stackBehavior: "replace",
      });
    } else {
      await SheetManager.show("push-demo-1", {
        stackBehavior: "push",
      });
    }
  };
        ...
        <View style={styles.container}>
          ...
          <View style={styles.descriptionContainer}>
            ...
            <Text style={styles.description}>
              Switch closes the current sheet before opening the new one. The previous
              sheet won't return when this one closes. This is the default behavior for
              modal transitions.
            </Text>
          </View>
          ...
          >
            ...
            <Text style={styles.nextButtonText}>Go to Depth 2</Text>
          </Pressable>
